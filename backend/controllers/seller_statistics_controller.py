...
class SellerStatisticsController:
    ...
    async def get_monthly_transactions(self, seller_id: UUID, selected_date: SelectedMonthForSellerStatistics):
        try:
            return await self._service.get_monthly_transactions(seller_id, selected_date)
