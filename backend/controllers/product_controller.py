...
class ProductController:
    ...
    async def get_product_by_id(self, product_id: int) -> JSONResponse:
        try:
    ...
    async def get_all_products(self) -> JSONResponse:
        try:
    ...
    async def get_all_products_by_seller(self, seller_id: UUID) -> JSONResponse:
        try:
