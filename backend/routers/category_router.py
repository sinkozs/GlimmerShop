...
from schemas.schemas import CategoryUpdate, CategoryQuery, CategoryToProductRequest, CategoryIdentifiers
...
async def get_category_name_by_id(category_id: int, controller: CategoryController = Depends(get_category_controller)):
