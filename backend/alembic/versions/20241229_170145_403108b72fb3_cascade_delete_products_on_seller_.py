"""Cascade delete products on seller deletion

Revision ID: 403108b72fb3
Revises: 15877271074c
Create Date: 2024-12-29 17:01:45.737564
...
revision = "403108b72fb3"
down_revision = "15877271074c"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["seller_id"], ["public.user.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
        schema="public",
    )
    op.create_index(
