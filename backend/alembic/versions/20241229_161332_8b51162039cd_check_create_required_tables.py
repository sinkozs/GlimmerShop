...
def upgrade():
    ...
    if "cart" not in existing_tables:
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["user_id"], ["public.user.id"], ondelete="CASCADE"
            ),
            schema="public",
        )
        op.create_index(
            op.f("ix_cart_id"), "cart", ["id"], unique=False, schema="public"
        )
    ...
    if "cart_item" not in existing_tables:
        op.create_table(
            ...
            sa.PrimaryKeyConstraint("id"),
            sa.ForeignKeyConstraint(
                ["cart_id"], ["public.cart.id"], ondelete="CASCADE"
            ),
            sa.ForeignKeyConstraint(
                ["product_id"], ["public.product.id"], ondelete="CASCADE"
            ),
            schema="public",
        )
        op.create_index(
            op.f("ix_cart_item_id"), "cart_item", ["id"], unique=False, schema="public"
        )
